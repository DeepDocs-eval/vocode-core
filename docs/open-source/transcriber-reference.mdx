...
<ParamField body="model" type="Optional[str]">
  Optional Deepgram model to use for transcription.
</ParamField>
...
<ParamField body="version" type="Optional[str]">
  Optional Deepgram version to use for transcription.
</ParamField>
...
<ParamField body="buffer_size_seconds" type="float">
  Buffer duration in seconds to accumulate audio before sending to AssemblyAI.
</ParamField>
...
<ParamField body="buffer_size_seconds" type="float">
  Buffer duration in seconds to accumulate audio before sending to WhisperCPP.
</ParamField>
...
<ParamField body="buffer_size_seconds" type="float">
  Buffer duration in seconds to accumulate audio before sending to Gladia.
</ParamField>
